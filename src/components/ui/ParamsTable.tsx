  ...
  return (
    <div className="my-6">
      ...
      <div className="rounded-xl border border-border overflow-hidden">
        <div className="grid grid-cols-[140px_1fr] sm:grid-cols-[200px_1fr] text-xs font-semibold bg-primary/10 text-primary border-b border-border">
        ...
        {params.map((p, i) => (
          <div
            key={i}
            className={`grid grid-cols-[140px_1fr] sm:grid-cols-[200px_1fr] border-b border-border last:border-0 ${
              i % 2 === 0 ? "bg-card" : "bg-muted/20"
            }`}
          >
            <div className="px-4 py-3 font-mono text-primary text-xs leading-relaxed self-start break-all">
              {p.flag}
            </div>

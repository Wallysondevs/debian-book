...
echo "=== Tudo pronto. Reinicie o sistema. ==="`,
...

  {
    ...
    content: [
      ...
      "**Tasksel e display manager:** task-gnome-desktop, task-xfce-desktop etc. puxam o meta-conjunto Debian. O display manager (gdm3, lightdm, sddm) mostra o login — trocar desktop sem olhar o DM deixa o boot estranho. VPS em geral não precisa de GUI.",

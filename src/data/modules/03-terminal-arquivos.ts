...
ls /proc | grep -c '^[0-9]'`,
    ...
    references: [
      ...
      { title: "man hier — descrição da hierarquia", url: "https://manpages.debian.org/trixie/manpages/hier.7.en.html" },
    ],
  },
...
rm -r /tmp/projeto-longo`,
    ...
    references: [
      ...
      { title: "man rm — Debian", url: "https://manpages.debian.org/trixie/coreutils/rm.1.en.html" },

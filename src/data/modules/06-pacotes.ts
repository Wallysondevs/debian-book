...
dpkg -l | grep ^rc`,
...

  {
    ...
    content: [
      ...
      "**DEB822 lado a lado:** o formato clássico de uma linha `deb http://... suite main` convive com blocos em `/etc/apt/sources.list.d/*.sources` (Types/URIs/Suites/Components/Signed-By). O capítulo `deb822-sources` aprofunda; aqui o mínimo é: não misture a mesma suíte duas vezes com opções conflitantes, e prefira `Signed-By:` em vez de `apt-key`.",

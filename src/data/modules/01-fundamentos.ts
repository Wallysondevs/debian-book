...
export const fundamentos: Module[] = [
  {
    ...
    commands: [
      ...
      },
      {
        ...
        output: "model name      : (exemplo) AMD EPYC / Intel Xeon — o seu será diferente",
      },
      {
        command: "nproc",
    ...
    tips: [
      {
        ...
        content:
          "Servem para ler formato, não copiar o modelo de CPU.",
      },
    ...
    tips: [
      {
        ...
        title: "Bookworm+",
        content:
          "non-free-firmware é o nome certo.",
      },
      {
        type: "warning",
        title: "Minimal cloud",
        content:
          "Imagens slim podem omitir firmware de bare metal.",
      },
